      ...
      >
        ...
        <div className="w-full max-w-4xl">
          ...
          <form className="space-y-4">
            ...
            {!isLogin && (
              <div className="flex flex-col lg:flex-row gap-3">
                <input
                  ...
                  className="w-full lg:w-1/2 border rounded-3xl p-3"
                  style={inputStyle}
                />
            ...
            <div className="flex flex-col lg:flex-row gap-3">
              ...
              <div className="relative w-full lg:w-1/2">
                <input
                  ...
                  className="w-full border rounded-3xl p-3 pr-12"
                  style={inputStyle}
                />
            ...
            {/* Submit */}
            <button
              className="w-full py-3 rounded-3xl font-semibold"
              style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
            <SocialIcon src="/src/assets/Images/google-icon.png" />
            <SocialIcon src="/src/assets/Images/facebook-icon.png" />
            <SocialIcon src="/src/assets/Images/apple-icon.png" />
          </div>
          ...
          >
            ...
            <button className="ml-2" style={{ color: "var(--primary-color)" }}>
...
const SocialIcon = ({ src }: { src: string }) => (
  <button
    className="rounded-3xl p-2 flex justify-center cursor-pointer"
    style={{ borderColor: "var(--grey-30)" }}
  >
    <img src={src} alt="social" className="w-20 h-20" />
  </button>
);
